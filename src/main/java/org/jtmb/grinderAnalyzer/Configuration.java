...
public class Configuration {
	...
	private void loadConfig() {
		...
		final String thresholdsProperty = props.getProperty("response_time_thresholds", "");
		if (thresholdsProperty != "") {
			for (final String word : thresholdsProperty.split(",")) {
	...
	private Float getFloatProperty(final String propname, final String defaultValue) {
		Float floatProp = null;
		final String property = props.getProperty(propname, defaultValue);
		try {
	...
	private Integer getIntProperty(final String propname, final String defaultValue) {
	...
	private boolean getBoolProperty(final String propname, final String defaultValue) {
		final String property = props.getProperty(propname, defaultValue);
	...
	public String toString() {
		final StringBuffer sb = new StringBuffer("GRINDER ANALYZER CONFIG" + NEWLINE);
		...
		if (this.useThresholds) {
			...
			for (final Float threshold : rtimeThresholds) {
